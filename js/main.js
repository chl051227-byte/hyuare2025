...
const students = [
    ...
    { name: "이상휘", title: "드론을 활용한 외벽 점검 시스템", desc: "Prof. 한상환" },
    ...
    // 4열
    { name: "카잉윈티탄트", title: "지속가능한 지역 재활성화와 보행 친화성을 위한 서울역 복합환승 허브 재개발 제안", desc: "Prof. 최창식" },
    { name: "보연영", title: "슬래그 특성을 고려한 3D 프린팅 콘크리트의 성능 및 구조 적합성 평가", desc: "Prof. 최창식" },
    { name: "백인휘", title: "콘크리트 슬래브의 갈고리 겹침이음길이에 따른 이음강도평가", desc: "Prof. 최창식" },
    { name: "곽현오", title: "목재의 밀도 및 투수성을 고려한 탄화깊이식 제안", desc: "Prof. 최창식" },
    { name: "한재혁", title: "외기 도입 기준 방식에 따른 에너지 절감 효과 비교", desc: "Prof. 정재원" },
    { name: "한성우", title: "LLM을 활용한 그래스호퍼 기반 대화형 설계 및 외피 일사량 최적화 알고리즘 연구", desc: "Prof. 정재원" },

    // 5열
    { name: "이재훈", title: "경제성과 환경성을 고려한 2050년 대한민국 최적 전원믹스 시뮬레이션", desc: "Prof. 정재원" },
    { name: "송현우", title: "콘크리트 균열 자기 치유 기술", desc: "Prof. 정재원" },
    { name: "박호일", title: "재실자수에 따른 디맨드 컨트롤 에너지 절감 효과분석", desc: "Prof. 정재원" },
    ...
    { name: "정지환", title: "초장대 교량의 케이블 해석", desc: "Prof. 유은종" },
    ...
    // 7열
    { name: "윤준성", title: "딥러닝 의미 분할을 활용한 건축 도면 지능형 노이즈 제거 및 중심선 추출", desc: "Prof. 유은종" },
    { name: "묘묘", title: "노후 단독주택의 리모델링에 대한 모듈러 공법 적용 연구- 공간 확장과 증축 중심으로", desc: "Prof. 유은종" },
    { name: "최동혁", title: "컴퓨터 비전 기반 CNN 전이학습 모델의 콘크리트 순환골재 미분말 함유량 예측 모델 성능 비교 연구", desc: "Prof. 배성철" },
    { name: "정희찬", title: "3D 프린팅 콘크리트의 골재량 및 PP섬유 혼입률이 유변학적 특성 및 소성 수축 균열에 미치는 상호 영향 분석", desc: "Prof. 배성철" },
    { name: "정윤아", title: "굴패각을 활용한 알칼리 활성 고로슬래그 경화체의 기초적 특성에 관한 연구", desc: "Prof. 배성철" },
    { name: "정민성", title: "바인더 젯팅 3D 프린팅 시멘트 모르타르의 기계적 특성 및 치수 정확도에 미치는 열", desc: "Prof. 배성철" },

    // 8열
    { name: "장훈희", title: "폐콘크리트 침목 골재 전처리에 따른 흡음 블록 제작 가능성 평가", desc: "Prof. 배성철" },
    { name: "임영채", title: "소듐 알루미네이트 함량에 따른 알칼리 활성화 폐콘크리트 미분말의 강도 발현 메커니즘", desc: "Prof. 배성철" },
    { name: "임여진", title: "SCMs를 혼입한 폐콘크리트 미분말의 2단계 탄산화 반응을 통해 생성된 실리카겔의 특성에 관한 연구", desc: "Prof. 배성철" },
    { name: "유창모", title: "알칼리 토금속 이온을 첨가한 이산화탄소 반응경화형 결합재의 반응 생성물 형태 특성 및 기계적 물성 분석", desc: "Prof. 배성철" },
    { name: "안병건", title: "VMA 함량이 3D 프린팅 콘크리트의 유변학적 특성에 미치는 영향 연구", desc: "Prof. 배성철" },
    { name: "손명규", title: "그래핀 옥사이드(GO)가 첨가된 칼슘 실리케이트 수화물(CSH) 페이스트의 화학적 구조 특성에 관한 연구", desc: "Prof. 배성철" },

    // 9열
    { name: "문태선", title: "나노 TiO2 다형체가 탄산화 양생한 γ-C2S 클링커의 반응 생성물 및 기계적 물성에 미치는 영향", desc: "Prof. 배성철" },
    { name: "김영찬", title: "고온 양생 조건에서 PLC 삼성분계 바인더의 반응 특성 및 서중 콘크리트 적용 가능성 연구", desc: "Prof. 배성철" },
    { name: "김서영", title: "알카놀아민계 혼화제를 혼입한 석회석, 슬래그 혼합 시멘트의 물성 및 강도 실험을 통한 현장 적용성 평가", desc: "Prof. 배성철" },
    { name: "권희선", title: "층상 이중 수산화물/그래핀 옥사이드 복합체가 첨가된 해수 혼합 알칼리 활성화 슬래그의 특성 분석", desc: "Prof. 배성철" },
    { name: "장영환", title: "해석 가능 AI 기반 서울시 상권 매출영향 요인 분석", desc: "Prof. 김주형" },
    { name: "이서연", title: "실물옵션 도입을 가정한 이산화탄소 및 그린수소 활용 e-메탄을 생산 국내 도입 타당성 분석", desc: "Prof. 김주형" },

    // 10열
    { name: "윤태웅", title: "임대주택 브랜드 오퍼레이터가 오피스텔 임대시장에 미치는 영향 분석", desc: "Prof. 김주형" },
    { name: "송낙범", title: "머신러닝 기반 주요 업무 권역 부동산 투자 자본환원율(Capitalization Rate) 예측모형 비교", desc: "Prof. 김주형" },
    { name: "박다연", title: "패널 회귀분석을 통한 건설기업 재무성과와 거시경제변수 간의 상관관계 분석", desc: "Prof. 김주형" },
    { name: "김재원", title: "거대 언어 모델 기반 시방 준수 검토 성능 향상을 위한 검색 증강 생성 기법의 효과성 검증", desc: "Prof. 김주형" },
    { name: "고예성", title: "교량 상판 균열 모니터링 디지털 트윈 구현을 위한 3D 가우시안 스플래팅 활용 포토그래메트리 방법론 제안", desc: "Prof. 김주형" },
    { name: "가한결", title: "진도관리를 위한 하이브리드 데이터셋 기반 자재 반입 As-Built 데이터 수집 자동화 시스템 제안 및 적용성 검증", desc: "Prof. 김주형" },
];
...
const animationScrollRange = 0.1;    // 전체 스크롤의 30% 구간 동안 애니메이션 (0 ~ 1) 
